...
require_once(PHPEXCEL_ROOT . 'PHPExcel/Reader/Exception.php');
require_once(PHPEXCEL_ROOT . 'PHPExcel/Shared/OLE/PPS.php');
require_once(PHPEXCEL_ROOT . 'PHPExcel/Shared/OLE/PPS/Root.php');
require_once(PHPEXCEL_ROOT . 'PHPExcel/Shared/OLE/PPS/File.php');
