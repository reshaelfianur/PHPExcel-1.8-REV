...
require_once('CachedObjectStorage/Memory.php');
require_once('CachedObjectStorage/MemoryGZip.php');
require_once('CachedObjectStorage/MemorySerialized.php');
require_once('CachedObjectStorage/Igbinary.php');
require_once('CachedObjectStorage/DiscISAM.php');
require_once('CachedObjectStorage/APC.php');
require_once('CachedObjectStorage/Memcache.php');
require_once('CachedObjectStorage/PHPTemp.php');
require_once('CachedObjectStorage/Wincache.php');
require_once('CachedObjectStorage/SQLite.php');
require_once('CachedObjectStorage/SQLite3.php');
