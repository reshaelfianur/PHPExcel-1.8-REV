...
require_once(PHPEXCEL_ROOT . 'PHPExcel/Shared/CodePage.php');
...
require_once(PHPEXCEL_ROOT . 'PHPExcel/Exception.php');
...
require_once('DefaultReadFilter.php');
require_once('Exception.php');

require_once('Excel5/Escher.php');
require_once('Excel5/Color.php');
require_once('Excel5/RC4.php');
require_once('Excel5/MD5.php');
require_once('Excel5/ErrorCode.php');
require_once('Excel5/Style/Border.php');
require_once('Excel5/Style/FillPattern.php');
