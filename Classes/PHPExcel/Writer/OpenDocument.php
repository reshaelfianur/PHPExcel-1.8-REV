...
require_once('OpenDocument/MetaInf.php');
require_once('OpenDocument/Mimetype.php');
require_once('OpenDocument/Settings.php');
require_once('OpenDocument/Styles.php');
require_once('OpenDocument/Thumbnails.php');
