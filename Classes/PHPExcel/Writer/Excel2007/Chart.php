...
require_once(PHPEXCEL_ROOT . 'PHPExcel/Chart.php');
require_once(PHPEXCEL_ROOT . 'PHPExcel/Chart/Title.php');
require_once(PHPEXCEL_ROOT . 'PHPExcel/Chart/Legend.php');
require_once(PHPEXCEL_ROOT . 'PHPExcel/Chart/PlotArea.php');
require_once(PHPEXCEL_ROOT . 'PHPExcel/Chart/Axis.php');
require_once(PHPEXCEL_ROOT . 'PHPExcel/Chart/GridLines.php');
require_once(PHPEXCEL_ROOT . 'PHPExcel/Chart/DataSeries.php');
require_once(PHPEXCEL_ROOT . 'PHPExcel/Chart/Layout.php');

require_once(PHPEXCEL_ROOT . 'PHPExcel/Shared/XMLWriter.php');
require_once(PHPEXCEL_ROOT . 'PHPExcel/Shared/String.php');

require_once(PHPEXCEL_ROOT . 'PHPExcel/Writer/Exception.php');
